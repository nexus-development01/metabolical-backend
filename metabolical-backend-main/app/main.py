...
try:
    ...
    from .cache_manager import cache_manager, warm_cache, setup_cache_refresh
except ImportError:
    import sys
...
async def startup_event():
    ...
    try:
        ...
        logger.warning(f"⚠️ Database optimization warning: {e}")
    ...
    try:
        ...
        return {
            ...
            "cache_performance": {
                ...
                "hit_ratio": "Not available (would need hit/miss tracking)"
            },
